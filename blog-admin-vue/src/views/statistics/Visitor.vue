		...
		<el-table :data="visitorList">
			...
			<el-table-column width="170">
				<template slot="header" slot-scope="scope">
					最后访问
					<el-tooltip effect="dark" content="每日凌晨自动更新" placement="com"><i class="el-icon-question"></i></el-tooltip>
				</template>
			...
			<el-table-column prop="pv" width="70">
				<template slot="header" slot-scope="scope">
					PV
					<el-tooltip effect="dark" content="访客总浏览量，每日凌晨自动更新" placement="com"><i class="el-icon-question"></i></el-tooltip>
				</template>
			</el-table-column>
