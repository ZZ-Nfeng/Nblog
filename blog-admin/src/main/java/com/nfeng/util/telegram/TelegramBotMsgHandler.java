package com.nfeng.util.telegram;
...
import com.nfeng.config.properties.TelegramProperties;
import com.nfeng.entity.Comment;
import com.nfeng.entity.Moment;
import com.nfeng.enums.CommentPageEnum;
import com.nfeng.service.CommentService;
import com.nfeng.service.MomentService;
...
public class TelegramBotMsgHandler {
	...
	private String replyComment(String msgContent) {
		...
		if (splitIndex2 != -1 && msgContent.length() > splitIndex2 + 1) {
			...
			com.nfeng.model.dto.Comment comment = new com.nfeng.model.dto.Comment();
