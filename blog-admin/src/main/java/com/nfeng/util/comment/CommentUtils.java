package com.nfeng.util.comment;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.context.annotation.DependsOn;
import org.springframework.stereotype.Component;
import com.nfeng.config.properties.BlogProperties;
import com.nfeng.constant.PageConstants;
import com.nfeng.constant.RedisKeyConstants;
import com.nfeng.entity.User;
import com.nfeng.model.dto.Comment;
import com.nfeng.model.vo.FriendInfo;
import com.nfeng.service.AboutService;
import com.nfeng.service.BlogService;
import com.nfeng.service.FriendService;
import com.nfeng.service.RedisService;
import com.nfeng.service.UserService;
import com.nfeng.util.HashUtils;
import com.nfeng.util.IpAddressUtils;
import com.nfeng.util.MailUtils;
import com.nfeng.util.QQInfoUtils;
import com.nfeng.util.StringUtils;
import com.nfeng.util.comment.channel.ChannelFactory;
import com.nfeng.util.comment.channel.CommentNotifyChannel;
import com.nfeng.enums.CommentOpenStateEnum;
import com.nfeng.enums.CommentPageEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.nfeng.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.nfeng.entity.Comment parentComment, Comment comment) {
