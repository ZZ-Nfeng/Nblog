package com.nfeng.controller.admin;
...
import com.nfeng.annotation.OperationLogger;
...
public class BlogAdminController {
	...
	@PostMapping("/blog")
	public Result saveBlog(@RequestBody com.nfeng.model.dto.Blog blog) {
	...
	@PutMapping("/blog")
	public Result updateBlog(@RequestBody com.nfeng.model.dto.Blog blog) {
	 ...
	 * @return
	 */
	private Result getResult(com.nfeng.model.dto.Blog blog, String type) {
		//验证普通字段
